...
8. 作为新用户，我希望从 GitHub `v2.1.3` Release 下载 npm tarball，在全新目录安装并按照 README 完成配置与运行。
...
- `pnpm pack` 生成 `ai4se-harness-2.1.3.tgz` Harness/CLI npm tarball。
...
| 托管部署 | 助教补充说明允许 CLI 项目提供托管平台 Release；使用 GitHub `v2.1.3` Release | T17/总控发布 |
